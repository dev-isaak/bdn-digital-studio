	...
	const serviciosSection = [
		{
			...
			text: "Creación y planificación de contenido adaptado a tu negocio y audiencia. Publicaciones que informan, entretienen y convierten. Si lo necesitas, también realizamos servicios de fotografía de producto para garantizar contenido visual de calidad.",
		},
		{
