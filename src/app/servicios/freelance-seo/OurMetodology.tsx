...
export default function OurMetodology() {
  ...
  const nuestraMetodologia = [
    ...
    },
    {
      ...
      body: "<p>El keyword research es un ámbito que como freelance SEO trabajamos de manera personalizada para cada cliente. Hacemos un estudio de las palabras que vamos a trabajar según tu negocio y un análisis de la competencia para poder trabajar de la forma más precisa posible.</p>",
    },
    {
      title: "Reportes",
      icon: <FaRegChartBar size={32} color="#444444" />,
      body: "<p>Todo el trabajo que hacemos como agencia SEO no queda en el aire sino que generamos reportes mes a mes basados en los KPI's y en el SEO, así podemos redefinir objetivos cuando sea necesario.</p>",
      isOdd: true,
    },
  ];
  return (
